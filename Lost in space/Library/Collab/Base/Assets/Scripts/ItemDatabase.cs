    ...
    */
    private void BuildItemDatabase()
    {
        items = new List<ItemData>()
        {
           ...
           new ItemData("Canned food", "Pig in can.",
           new Dictionary<string, int>{
                { "food", 20 }
            }, ItemType.inventory_items),
           ...
           new ItemData("Workbench", "You can make stuff here.",
           new Dictionary<string, int>{
            }, ItemType.ship_upgrade),
           ...
           new ItemData("Shield for the asteroid belt", "You can cross the asteroid belt.. finnaly.",
           new Dictionary<string, int>{
                { "time", 10 }
            }, ItemType.inventory_items),
